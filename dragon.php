...
echo "\033[1;92mLua chon: \033[1;33m";
  ...
  system('pkg install openjdk-17 -y -y && wget -O src.zip  https://github.com/MinhDang09/Dragonboy/blob/main/src.zip?raw=true && unzip src.zip && clear ');
...
system('clear');
    ...
    sleep(1);
        while (true){
$checkkey  = file('https://pastebin.com/raw/jTUGC329'); //// Linh Key
